...
const Tasks = () => {
  return (
    <div className="h-screen grid grid-cols-1 lg:grid-cols-12">
      <div className="col-span-9 px-2 lg:px-10 pt-10">
        <div className="flex justify-between items-center ">
          <div>
            <h1 className="font-semibold text-sm lg:text-3xl">Tasks</h1>
          </div>
          <div className="flex gap-1 lg:gap-5">
            ...
            <button className="btn btn-primary text-xs lg:text-sm">
              Add Task
            </button>
